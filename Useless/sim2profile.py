...
rds = np.linspace(0.1, 12.8, 20)   # Creating range of radii (start, end, step)
...
import cProfile
cProfile.run("av_distance_calc(1000, 50, 1, 2)", "output.dat")
# cProfile.run("main_func()", "output.dat")
